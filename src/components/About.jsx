    ...
    <div>
      ...
      <main>
        ...
        <p className="about-text">
          ...
          ruins of the "Solarium" underground party series that operated from
          2015 till 2020. During this sequence, unique talents from all over the
          scale came to Berlin to provide a unique cultural experience. <br />
          <br />
          Punk and kraut rock, multi-layered dance music and flute melodies in a
          time machine from the seventies The character and uniqueness of the
          establishment lies in the variety and ability to find language and a
          bridge between all those in which there is a spark, all of us.
          <br />
          <br />
